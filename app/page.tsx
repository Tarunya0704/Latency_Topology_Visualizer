          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 lg:gap-0">
            <div className="flex items-center gap-2 md:gap-4 w-full lg:w-auto">
              <div className="relative flex-shrink-0">
                ...
                <div className={`absolute -top-1 -right-1 w-2 h-2 md:w-3 md:h-3 rounded-full animate-pulse ${
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className={`text-xs md:text-sm mt-0.5 ${darkMode ? 'text-gray-400' : 'text-gray-600'} hidden sm:block truncate`}>
            ...
            <div className="flex items-center gap-2 md:gap-4 w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0">
              <div className={`flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1.5 md:py-2 rounded-lg border flex-shrink-0 ${
              ...
              <div className={`px-2 md:px-4 py-1.5 md:py-2 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-gray-100'} border ${darkMode ? 'border-gray-700' : 'border-gray-300'} flex-shrink-0`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
          ...
          <div className="lg:col-span-6">
            <div className={`${darkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-200'} rounded-lg shadow-xl border overflow-hidden`}>
              <div className={`p-3 md:p-4 border-b ${darkMode ? 'border-gray-800 bg-gray-800/50' : 'border-gray-200 bg-gray-50'}`}>
              ...
              <div className="h-[400px] sm:h-[500px] md:h-[600px] lg:h-[650px] relative">
              ...
              <div className={`p-2 md:p-3 border-t ${darkMode ? 'border-gray-800' : 'border-gray-200'}`}>
                <div className="flex items-center justify-between text-[10px] md:text-xs">
                  <div className="flex items-center gap-2 md:gap-4">
                    ...
                    <span className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} hidden sm:inline`}>🔍 Scroll</span>
                  </div>
      ...
      <footer className={`${darkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-200'} border-t mt-12`}>
        <div className="max-w-7xl mx-auto px-3 sm:px-6 py-4 md:py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            <div className={`text-xs md:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'} text-center md:text-left`}>
